...
export default function ExpenseForm({ onSubmitSuccess, editingExpense }: Props) {
  ...
  useEffect(() => {
    editingExpense ? 
      reset({...editingExpense, date: new Date(editingExpense.date + 'T00:00:00') }) : 
      reset()
  },[editingExpense]);
  ...
  return (
    <YStack flex={1} backgroundColor="$ivory">
      ...
      >
        ...
        {editingExpense && (
          <Pressable onPress={onSubmitSuccess}>
